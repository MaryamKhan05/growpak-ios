...
import { FarmFullEngReport } from "../../engScreens/Index";
...
const FarmFullReport = () => {
  ...
  console.log("report response", response?.report_lang);
                    ...
                    <FlatList
                      ...
                      renderItem={({ item }) => {
                        ...
                        return (
                          ...
                          >
                            <Text
                              style={[{ width: wp(75) }, styles.marhlaText]}
                            >
                              {item}
                            </Text>
