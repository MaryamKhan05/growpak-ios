...
import { GET_SOC, GET_PH, GET_WS } from "../../GraphQl/queries";
...
const FarmExample = () => {
  ...
  // console.log(carbonData,'carbon datatttatatattat')
  // console.log(waterData,'waterData datatttatatattat')
  console.log(plantHealthData, "plantHealthData datatttatatattat");
