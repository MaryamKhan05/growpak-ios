  ...
  const renderItem = ({ item }) => {
    ...
    return (
      <View style={styles.listCard}>
        ...
        >
          <Text style={{ fontSize: 16, fontWeight: "600", width: wp(25) }}>
            {today[0]}
          </Text>

          {/* <View>
            {item.record[0].weather[0].main === "Clear" && (
              <Fontisto name="day-sunny" size={30} color="black" />
            )}
            {item.record[0].weather[0].main === "Clouds" && (
              <Fontisto name="day-cloudy" size={30} color="black" />
            )}
            {item.record[0].weather[0].main === "Snow" && (
              <Fontisto name="day-cloudy" size={30} color="black" />
            )}
            {item.record[0].weather[0].main === "Rain" && (
              <Fontisto name="day-rain" size={30} color="black" />
            )}
            {item.record[0].weather[0].main === "Mist" ||
              item.record[0].weather[0].main === "Smoke" ||
              item.record[0].weather[0].main === "Haze" ||
              item.record[0].weather[0].main === "Dust" ||
              item.record[0].weather[0].main === "Fog" ||
              item.record[0].weather[0].main === "Sand" ||
              item.record[0].weather[0].main === "Dust" ||
              item.record[0].weather[0].main === "Ash" ||
              item.record[0].weather[0].main === "Squall" ||
              (item.record[0].weather[0].main === "Tornado" && (
                <Fontisto name="fog" size={30} color="black" />
              ))}
            {item.record[0].weather[0].main === "Drizzle" && (
              <Fontisto name="rains" size={30} color="black" />
            )}
            {item.record[0].weather[0].main === "Thunderstorm" && (
              <Ionicons name="thunderstorm-outline" size={30} color="black" />
            )}
            {item.record[0].weather[0].main === "Snow" && (
        ...
        {selectedItem == item.id ? (
          <View style={{}}>
            <View style={styles.row}>
              ...
              <View style={styles.column}>
                <Text style={styles.text}>Feels (°C)</Text>
            ...
            <View style={styles.row}>
              ...
              <View style={styles.column}>
                <Text style={styles.text}>Rain Chances (%)</Text>
          ...
          >
            ...
            >
              ...
              <View style={styles.detailsContainer}>
                <Text style={styles.hourlyText}>Humidity (%)</Text>
                <Text style={{}}>{modalHumidity}</Text>
              </View>
              <Separator />
              <View style={styles.detailsContainer}>
                <Text style={styles.hourlyText}>Speed (m/s)</Text>
                <Text style={{}}>{speed}</Text>
              </View>
              <Separator />
              <View style={styles.detailsContainer}>
                <Text style={styles.hourlyText}>Rain Chances (%)</Text>
                <Text style={{}}>{rainChances}</Text>
              </View>
            </View>
          </View>
        </Modal>
